...
export function ScreenStart({
  ...
  return (
    <div className="relative flex min-h-0 w-full flex-1 flex-col overflow-visible bg-gradient-to-b from-[#05a8ff] to-[#057ccc] pt-10">
      ...
      <div className="relative z-[1] flex min-h-0 min-w-0 w-full flex-1 flex-col overflow-y-auto">
        ...
        <div className="relative flex min-h-0 w-full flex-1 flex-col items-stretch">
          ...
          <div
            className="flex min-h-[448px] flex-1 flex-col gap-10 rounded-t-[32px] px-4 pb-[max(1rem,env(safe-area-inset-bottom))] pt-10"
            style={{
              background:
          ...
          >
            ...
            <div className="flex min-h-0 flex-1 flex-col gap-2">
              ...
              <div
                ...
                style={{
                  minHeight:
                    "max(0px, calc(env(safe-area-inset-bottom, 0px)))",
                  width: "100%",
                }}
              />
            </div>
